...
from fa.inner_loop.workflow_controller import run_workflow, workflow_exit_code
...
def run(label, eval_text, rid):
    ...
    print(
        f"{label:34s} status={st.status:16s} exit={workflow_exit_code(rc, st)} "
