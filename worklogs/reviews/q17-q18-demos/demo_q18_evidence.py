...
from fa.inner_loop.workflow_controller import WorkflowContext, _eval_evidence_block, workflow_artifact_paths
...
ctx = WorkflowContext(
    run_id="r",
    base_task="Judge whether the coder completed the plan.",
    per_role_task={},
