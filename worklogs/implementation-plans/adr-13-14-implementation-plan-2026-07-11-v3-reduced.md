...
- Update llms.txt, DIGEST.md, HANDOFF.md§Next per doc-maintenance skill
...
- Update DIGEST.md, HANDOFF.md, llms.txt BY-DEMAND INDEX per doc-maintenance skill link integrity, markdown-link-check, no shell=True without # nosemgrep + ADR-6, no Level-0 TCB import external lib per ADR-11
