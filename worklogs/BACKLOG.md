...
> [`project-overview.md` §1.3](../knowledge/project-overview.md#13-three-stage-project-evolution)).
...
- **Blocked-on:** Implementation half of
  [ADR-7](../knowledge/adr/ADR-7-inner-loop-tool-registry.md) — the
...
- **First concrete step once unblocked:** Extend
  [`knowledge/prompts/architect-fa.md`](../knowledge/prompts/architect-fa.md)
...
- **Blocked-on:** Phase-M `src/fa/` runner (child-process
  ...
  [ADR-6](../knowledge/adr/ADR-6-tool-sandbox-allow-list.md), merge
...
- **Sub-agent invocation rules (R-23, captured 2026-05-20 docs-
  ...
  2. **Remove `SpawnSubAgent` from the sub-agent tool set.**
     ...
     recursion anti-pattern»](../knowledge/skills/pr-creation/SKILL.md#pr-checklist).
...
- **Blocked-on:** Same as I-1 (tool registry exists) **plus** the
  ...
  [`project-overview.md` §1.1](../knowledge/project-overview.md#11-четыре-столпа-цели-project-goal--four-pillars)
...
- **Unblock-trigger:** ADR-7 **and** ADR-8 both merged;
  ...
  loader contract.
- **First concrete step once unblocked:** Extend
  [`knowledge/prompts/RESOLVER.md`](../knowledge/prompts/RESOLVER.md) from
...
- **Status:** deferred from Stage 1 (proposed 2026-05-10
  critical-re-pass of `repo-audit-2026-05-10.md`).
- **Idea:** [`knowledge/prompts/RESOLVER.md`](../knowledge/prompts/RESOLVER.md)
  intent table routes T2-T5 (planner, coder, debug, eval) to
  template **sections** inside
  [`knowledge/prompts/prompting.md`](../knowledge/prompts/prompting.md)
...
- **First concrete step once unblocked:** Decide between (a)
  ...
  [`prompts/architect-fa.md`](../knowledge/prompts/architect-fa.md) /
  [`architect-fa-compact.md`](../knowledge/prompts/architect-fa-compact.md)
...
- **Idea:** Python script regenerates
  [`knowledge/llms.txt`](../knowledge/llms.txt) §BY-DEMAND INDEX from the
  ...
  fails CI. After landing, [`pr-creation` skill PR Checklist rule #7](../knowledge/skills/pr-creation/SKILL.md#pr-checklist)
  and [doc-maintenance skill §When adding a new file](../knowledge/skills/doc-maintenance/SKILL.md)
...
- **References:** the `llms.txt` auto-generator concept originated
  ...
  (current manual rule); [doc-maintenance skill §When adding a new file](../knowledge/skills/doc-maintenance/SKILL.md)
...
- **Idea:** Move bootstrap-cost from a one-off measurement
  (current [`research/bootstrap-cost-baseline-2026-05.md`](../knowledge/research/bootstrap-cost-baseline-2026-05.md))
...
- **Blocked-on:** UC5 eval-harness (per
  [ADR-1 Amendment 2026-05-06](../knowledge/adr/ADR-1-v01-use-case-scope.md))
...
- **First concrete step once unblocked:** Extend the UC5 metric
  ...
  the historical row.
- **References:** [`research/bootstrap-cost-baseline-2026-05.md`](../knowledge/research/bootstrap-cost-baseline-2026-05.md)
...
- **Unblock-trigger:** First-Agent Phase M ships an end-to-end
  ...
  [ADR-2](../knowledge/adr/ADR-2-llm-tiering.md)) capable of running the
...
- **First concrete step once unblocked:** Adapt the bootstrap
  ...
  **dropped** (their premise required the core to fail on
  ...
  in [`research/bootstrap-cost-baseline-2026-05.md`](../knowledge/research/bootstrap-cost-baseline-2026-05.md)
...
- **Status:** **closed by PR A' (2026-05-26)** — path (b) realised.
  ...
  ([`project-overview.md`:70](../knowledge/project-overview.md), the
...
- **Idea:** Stand up the minimal `src/fa/inner_loop/` package that
  ...
  [ADR-7 §2 / §8](../knowledge/adr/ADR-7-inner-loop-tool-registry.md) and the
  HookRegistry contract in
  [ADR-8](../knowledge/adr/ADR-8-hook-registry.md). Expected surface:
...
- **References that point here (12 sites across 6 files, added in
  Wave-0+Wave-1 PRs):**
  - [`knowledge/adr/ADR-8-hook-registry.md`](../knowledge/adr/ADR-8-hook-registry.md)
    lines 35, 107, 240, 307, 358.
  - [`knowledge/adr/DIGEST.md`](../knowledge/adr/DIGEST.md) line 244.
  - [`knowledge/adr/ADR-6-tool-sandbox-allow-list.md`](../knowledge/adr/ADR-6-tool-sandbox-allow-list.md)
    line 496.
...
- **Status:** **closed by PR-2 stacking on PR #24** (2026-05-20).
  ...
  - **R-6 attempt_history.json** —
    ...
    [`knowledge/prompts/coder-recovery.md`](../knowledge/prompts/coder-recovery.md)
...
- **Contract source:**
  [`knowledge/adr/ADR-9-llm-provider-client.md`](../knowledge/adr/ADR-9-llm-provider-client.md)
  — Option D + α (per-role explicit provider chain with
  cooldown) + companion survey
  [`knowledge/research/provider-client-survey-2026-05.md`](../knowledge/research/provider-client-survey-2026-05.md).
...
- **References:**
  ...
  - [`knowledge/adr/DIGEST.md` ADR-9 row](../knowledge/adr/DIGEST.md) —
    one-paragraph reading-cheat-sheet view.
  - [`knowledge/trace/exploration_log.md` Q-13](../knowledge/trace/exploration_log.md) —
...
- **Why milestone, not idea:** the contract is locked — the
  [`pr-creation` skill](../knowledge/skills/pr-creation/SKILL.md) §Reference
...
- **Contract source:** [`knowledge/skills/pr-creation/SKILL.md`](../knowledge/skills/pr-creation/SKILL.md)
  ...
  Anti-pattern back-stop: [`AP-003-shallow-fix-no-mechanism.md`](../knowledge/anti-patterns/AP-003-shallow-fix-no-mechanism.md)
...
- **References:**
  ...
  - [`knowledge/trace/exploration_log.md` Q-15](../knowledge/trace/exploration_log.md)
  ...
  - [`knowledge/anti-patterns/AP-003-shallow-fix-no-mechanism.md`](../knowledge/anti-patterns/AP-003-shallow-fix-no-mechanism.md)
...
- **Contract source:** [`knowledge/adr/ADR-8-hook-registry.md`](../knowledge/adr/ADR-8-hook-registry.md)
...
- **Why dual enforcement (hook + middleware):** the git hook
  ...
  earlier seat is the cheaper one per [`AP-001` §Why-wrong-shape-dominates](../knowledge/anti-patterns/AP-001-spec-bypassing-workaround.md#why-the-wrong-shape-dominates)
...
- **References:**
  ...
  - [`knowledge/trace/exploration_log.md` Q-15 §Coupling](../knowledge/trace/exploration_log.md)
...
- **Contract source:** the FA-ABC synthesis deep-dive
  [`fa-abc-synthesis-deep-dive-2026-05`](../knowledge/research/fa-abc-synthesis-deep-dive-2026-05.md)
  §3 (A-bucket residue, I-2 non-LLM determinism, I-4 typed loop-
  state ownership, I-5 deterministic post-LLM filter) +
  [`ADR-9` §2 step-by-step](../knowledge/adr/ADR-9-llm-provider-client.md)
  (per-call lifecycle) + [`ADR-7` §1](../knowledge/adr/ADR-7-inner-loop-tool-registry.md)
...
- **References:**
  - [`fa-abc-synthesis-deep-dive`](../knowledge/research/fa-abc-synthesis-deep-dive-2026-05.md)
    §3 (I-2 / I-4 / I-5).
  - [`ADR-9`](../knowledge/adr/ADR-9-llm-provider-client.md) §2 (runtime
    semantics) + §3 (cooldown) + §5 (adapter pattern).
  - [`ADR-8`](../knowledge/adr/ADR-8-hook-registry.md) §1 (lifecycle
    points).
  - [`ADR-7`](../knowledge/adr/ADR-7-inner-loop-tool-registry.md) §1
...
- **References:**
  ...
  - [`research/ci-qa-tooling-adversarial-2026-06.md`](../knowledge/research/ci-qa-tooling-adversarial-2026-06.md)
...
- **References:** [`research/ci-qa-tooling-adversarial-2026-06.md`](../knowledge/research/ci-qa-tooling-adversarial-2026-06.md) §0 R-7.
...
- **References:** [`research/ci-qa-tooling-adversarial-2026-06.md`](../knowledge/research/ci-qa-tooling-adversarial-2026-06.md) §0 R-8.
...
- **References:** [`research/ci-qa-tooling-adversarial-2026-06.md`](../knowledge/research/ci-qa-tooling-adversarial-2026-06.md) §0 R-9.
...
- **References:** [`research/ci-qa-tooling-adversarial-2026-06.md`](../knowledge/research/ci-qa-tooling-adversarial-2026-06.md) §0 R-10.
...
- **References:** [`research/ci-qa-tooling-adversarial-2026-06.md`](../knowledge/research/ci-qa-tooling-adversarial-2026-06.md) §0 R-11.
...
- **References:** [`research/ci-qa-tooling-adversarial-2026-06.md`](../knowledge/research/ci-qa-tooling-adversarial-2026-06.md) §0 R-12.
...
- **References:** [`research/ci-qa-tooling-adversarial-2026-06.md`](../knowledge/research/ci-qa-tooling-adversarial-2026-06.md) §0 R-13.
...
- **Blocked-on:** survivor-clearing work tracked in
  [`worklogs/implementation-plans/mutation-survivors-workplan.md`(../worklogs/implementation-plans/mutation-survivors-workplan.md
  (per-module table, clearing order, accepted-survivor rule).
- **Unblock-trigger:** `worklogs/implementation-plans/mutation-survivors-workplan.md` is **deleted**
...
- [`doc-maintenance skill`](../knowledge/skills/doc-maintenance/SKILL.md) — recurring
