...
def test_resolve_secrets_path_env_override(monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
...
def test_strict_file_only_ignores_environ(monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
